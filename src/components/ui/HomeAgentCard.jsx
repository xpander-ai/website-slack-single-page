          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <div className="flex items-center gap-3 mb-3">
              {agent.logo ? (
                ...
                <div className="w-12 h-12 rounded-xl overflow-hidden flex-shrink-0 bg-gray-50 border border-gray-100 flex items-center justify-center">
              ...
              <div className="mb-4 flex-shrink-0">
                <div className="flex flex-wrap gap-1.5">
                  {agent.skills.map((skill, index) => (
                    <span 
                      key={index}
                      className="px-2.5 py-1 text-xs font-medium bg-gradient-to-r from-[#6B4EFF]/10 to-blue-500/10 text-[#6B4EFF] border border-[#6B4EFF]/20 rounded-full"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            {/* Author info */}
            <div className="flex items-center justify-end gap-1 text-xs text-gray-500 flex-shrink-0">
              <span>by</span>
              {agent.authorLink ? (
                <a 
                ...
                <span className="font-semibold text-gray-900">{agent.author}</span>
              )}
            </div>
          </div>
        </div>
